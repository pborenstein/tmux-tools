...
**New users**: [README.md](../README.md) → [TROUBLESHOOTING.md](TROUBLESHOOTING.md)

**Developers**: [CONTRIBUTING.md](../CONTRIBUTING.md) → [ARCHITECTURE.md](ARCHITECTURE.md) → [DESIGN-PRINCIPLES.md](DESIGN-PRINCIPLES.md)

**Integrators**: [README.md - Scripting](../README.md#scripting) → [ARCHITECTURE.md - Command Dispatch](ARCHITECTURE.md#command-dispatch)
